...
namespace SalesForceOAuth.Web_API_Helper_Code
{
    public class Authentication
    {
        ...
        /// async System.Threading.Tasks.Task<HttpResponseMessage>
        public async System.Threading.Tasks.Task<AuthenticationResult> AcquireToken()
        {
            if (_config != null && (!string.IsNullOrEmpty(_config.Username) && _config.Password != null))
            {
               ...
               // UserCredential cred = new UserCredential(_config.Username, _config.Password);
                ...
                //   ClientCredential cc = new ClientCredential("1579d88e-bb6c-40ec-81ef-556c87319214", "g3P1ZtRjtZ3hKbw2xP6xcCVJWZfdkRLXG3j3NF4XVLc=");
                // return _context.AcquireToken(_config.ServiceUrl, _config.ClientId, cred);
                // return _context.AcquireToken(_config.ServiceUrl,cc.ClientId, cred);
