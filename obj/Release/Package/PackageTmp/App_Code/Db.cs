...
namespace SalesForceOAuth.App_Code
{
    ...
    public class Db
        ...
        public static void GetRedirectURLParameters(ref string sf_authoize_url, ref string sf_clientid,ref string sf_callback_url, string urlReferrer)
            {
                string connStr = MyAppsDb.GetConnectionStringbyURL(urlReferrer);
        ...
        public static void GetTokenParameters(ref string sf_callback_url, ref string sf_consumer_key, ref string sf_consumer_secret, ref string sf_token_req_end_point,string urlReferrer)
        {
            string connStr = MyAppsDb.GetConnectionStringbyURL(urlReferrer);
            MySqlConnection conn = new MySqlConnection(connStr);
            try
